...
REPOS = (
    ...
    'deb http://repos.stackops.net/ icehouse-dev main',
    #'deb http://repos.stackops.net/ icehouse main',
    #'deb http://repos.stackops.net/ icehouse-updates main',
    #'deb http://repos.stackops.net/ icehouse-security main',
    #'deb http://repos.stackops.net/ icehouse-backports main',
